...
QuantumXXZ(lat::Lattice, S::Real) = QuantumXXZ(lat, S, Random.seed!(Random.MersenneTwister(0)))
QuantumXXZ(lat::Lattice, S::Real, seed) = QuantumXXZ(lat, S, Random.seed!(Random.MersenneTwister(0), seed...))
