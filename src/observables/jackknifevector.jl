...
for op in (:+, :-)
    @eval Base.$op(jk::JackknifeVector, rhs::Real) = JackknifeVector(jk,
                                                                     lhs -> ($op)(lhs, rhs))
    @eval Base.$op(jk::JackknifeVector, rhs::Vector) = JackknifeVector(jk,
                                                                       lhs -> ($op)(lhs,
                                                                                    rhs))
    @eval Base.$op(lhs::Real, jk::JackknifeVector) = JackknifeVector(jk,
                                                                     rhs -> ($op)(lhs, rhs))
    @eval Base.$op(lhs::Vector, jk::JackknifeVector) = JackknifeVector(jk,
                                                                       rhs -> ($op)(lhs,
                                                                                    rhs))
    @eval Base.$op(lhs::JackknifeVector, rhs::JackknifeVector) = JackknifeVector(($op)(lhs.xs,
                                                                                       rhs.xs))
    @eval broadcast(::typeof($op), jk::JackknifeVector, rhs::Real) = JackknifeVector(jk,
                                                                                     lhs -> ($op)(lhs,
                                                                                                  rhs))
    @eval broadcast(::typeof($op), jk::JackknifeVector, rhs::Vector) = JackknifeVector(jk,
                                                                                       lhs -> ($op)(lhs,
                                                                                                    rhs))
    @eval broadcast(::typeof($op), lhs::Real, jk::JackknifeVector) = JackknifeVector(jk,
                                                                                     rhs -> ($op)(lhs,
                                                                                                  rhs))
    @eval broadcast(::typeof($op), lhs::Vector, jk::JackknifeVector) = JackknifeVector(jk,
                                                                                       rhs -> ($op)(lhs,
                                                                                                    rhs))
    @eval broadcast(::typeof($op), lhs::JackknifeVector, rhs::JackknifeVector) = JackknifeVector(($op)(lhs.xs,
                                                                                                       rhs.xs))
end
for op in (:*, :/, :\)
    @eval Base.$op(lhs::Real, jk::JackknifeVector) = JackknifeVector(jk,
